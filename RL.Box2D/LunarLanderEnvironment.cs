...
>
{
    ...
    private const float MainEnginePower = 15;
    private const float SideEnginePower = 0.8f;
    ...
    protected override Array1D<float> DoReset()
    {
        ...
        foreach (var i in Range<int>(chunks - 1))
        {
            ...
            var fixtureDef = new FixtureDef { shape = edgeShape, density = 0.0f, friction = 0.2f };
