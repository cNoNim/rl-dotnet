...
public partial class Drawer
{
    private class Triangles
    {
        ...
        public Triangles(Camera camera)
        {
            _camera = camera;
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, _vertices.Length * Vector2.SizeInBytes,
        ...
        public void Add(System.Numerics.Vector2 v1, System.Numerics.Vector2 v2, System.Numerics.Vector2 v3, Color color)
        {
            ...
            _colors[_count] = c;
            _count++;
            _vertices[_count] = ConvertVector(v3);
            _colors[_count] = c;
            _count++;
        }
        ...
        public void Flush()
        {
            ...
            _camera.BuildProjectionMatrix(matrix, 0.2f);
